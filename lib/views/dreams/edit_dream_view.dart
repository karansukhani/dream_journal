...
class EditDreamView extends StatefulWidget {
  ...
  @override
  State<EditDreamView> createState() => _EditDreamViewState();
}
...
class _EditDreamViewState extends State<EditDreamView> {
  ...
  late DreamClarity _selectedClarity;
  late DreamType _selectedType;
  ...
  void initState() {
    ...
    _selectedClarity = widget.dream.clarity;
    _selectedType = widget.dream.type;
    _tags = List.from(widget.dream.tags);
    _existingImageUrl = widget.dream.imageUrl;
  }
  ...
  void _updateDream() {
    if (_formKey.currentState!.validate()) {
      context.read<DreamCubit>().updateDream(
        id: widget.dream.id,
